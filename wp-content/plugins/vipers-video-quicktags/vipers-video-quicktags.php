...
<?php endif; ?>
		...
		<li id="vvq-parameters">
			...
			<div>
				...
				<ul>
					<li><code>[embed color1=&quot;FF0000&quot; color2=&quot;00FF00&quot; autoplay=&quot;1&quot;]http://www.youtube.com/watch?v=stdJd598Dtg[/embed]</code></li>
					<li><code>[googlevideo width=&quot;400&quot; height=&quot;300&quot;]http://video.google.com/videoplay?docid=-6006084025483872237[/youtube]</code></li>
					<li><code>[embed color=&quot;FFFF00&quot;]http://www.vimeo.com/240975[/embed]</code></li>
				</ul>
...
<?php
	...
	function shortcode_youtube( $atts, $content = '' ) {
		...
		return "<span class='vvqbox vvqyoutube'><iframe src='https://www.youtube.com/embed/".substr (strstr ($content, "="), 1, strlen (strstr ($content, "=")) - 1)."' onLoad='this.style.height=document.getElementById (\"primary\").offsetWidth * ".($height / $width)." + \"px\"'></iframe></span>";
	}
	...
	function shortcode_vimeo( $atts, $content = '' ) {
		...
		$width = $tags_w [0] -> content;
		$height = $tags_h [0] -> content;
		return "<span class='vvqbox vvqyoutube'><iframe src='https://player.vimeo.com/video/".substr (strrchr ($content, "/"), 1, strlen (strrchr ($content, "/")) - 1)."' onLoad='this.style.height=document.getElementById (\"primary\").offsetWidth * ".($height / $width)." + \"px\"'></iframe></span>";
	}
