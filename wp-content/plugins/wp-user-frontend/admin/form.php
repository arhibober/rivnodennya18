...
class WPUF_Admin_Form {
    ...
    function form_settings_posts() {
        ...
        $restrict_message      = __( "Ви не зайшли під своїм акаунтом.", 'wpuf' );
        ...
        $update_message        = isset( $form_settings['update_message'] ) ? $form_settings['update_message'] : __( 'Пост оновлено успішно', 'wpuf' );
